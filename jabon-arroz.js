...
document.addEventListener('DOMContentLoaded', function() {
        ...
        const currentProduct = { id: 2, name: "Jabón de Arroz", price: 9.00, image: "../img/jabon de arroz 01.png" };
        ...
        function showNotification(message) {
            ...
            notification.style.cssText = `position: fixed; top: 20px; right: 20px; background: var(--primary-color); color: white; padding: 1rem 2rem; border-radius: 25px; z-index: 3000; animation: slideIn 0.3s ease-out;`;
        ...
        if(searchBtnIcon) searchBtnIcon.addEventListener('click', (e) => { e.preventDefault(); searchModal.style.display = 'block'; searchInput.focus(); });
        if(cartBtnIcon) cartBtnIcon.addEventListener('click', (e) => { e.preventDefault(); renderCart(); cartModal.style.display = 'block'; });
        ...
        if(searchForm) searchForm.addEventListener('submit', (e) => { e.preventDefault(); renderSearchResults(searchProducts(searchInput.value.trim())); });
